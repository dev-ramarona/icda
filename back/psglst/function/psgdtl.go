		...
		for rawDtaset.Next(contxt) {
			...
			case "IRFRMT":
				writer.Write([]string{
					...
					slcDtaset.Flnbfl,
					strDatefl,
					slcDtaset.Depart + slcDtaset.Arrivl,
					slcDtaset.Clssfl,
					slcDtaset.Airlvc,
					slcDtaset.Flnbvc,
					strDatevc,
					strings.ReplaceAll(slcDtaset.Routvc, "-", ""),
					slcDtaset.Clssvc,
					slcDtaset.Nmefst,
					slcDtaset.Nmelst,
					slcDtaset.Groupc,
					fmt.Sprintf("%v", slcDtaset.Totpax),
					slcDtaset.Seatpx,
					fmt.Sprintf("%v %v%v/%v", slcDtaset.Codeir, slcDtaset.Airlir, slcDtaset.Flnbir, slcDtaset.Dateir),
					slcDtaset.Tktnvc,
					fmt.Sprintf("%v", slcDtaset.Cpnbvc),
					slcDtaset.Statvc,
					slcDtaset.Hmeloc + slcDtaset.Agtdie,
