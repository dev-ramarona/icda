import { MdlPsglstErrlogSrcprm, MdlPsglstPsgdtlSrcprm } from "../model/params";
...
export function FncPsglstPsgdtlSrcprm(
  ...
  return {
    ...
    isitif_psgdtl: params.isitif_psgdtl || "",
    isitwc_psgdtl: params.isitwc_psgdtl || "",
    isitpt_psgdtl: params.isitpt_psgdtl || "",
