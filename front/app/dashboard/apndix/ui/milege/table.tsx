...
import { MdlApndixAcpedtDtbase, MdlApndixMilegeFrntnd } from "../../model/parmas";
...
export default function UixPsglstMilegeTablex({
  arrdta,
  pagedb,
  acpedt,
  cookie,
}: {
  arrdta: MdlApndixMilegeFrntnd[];
  pagedb: string;
  ...
  const rawobj: MdlApndixMilegeFrntnd = FncGlobalIntialObject(arrdta[0]);
