...
import { MdlApndixAcpedtDtbase, MdlApndixFljoinFrntnd } from "../../model/parmas";
...
export default function UixPsglstFljoinTablex({
  ...
  const rawobj: MdlApndixFljoinFrntnd = FncGlobalIntialObject(arrdta[0]);
  let othrfn: Function | undefined;
  othrfn = (objdta: MdlApndixFljoinFrntnd) => {
