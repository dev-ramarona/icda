...
import { MdlApndixAcpedtDtbase, MdlApndixProvncDtbase } from "../../model/parmas";
...
export default function UixPsglstProvncTablex({
    ...
    const rawobj: MdlApndixProvncDtbase = {
        prmkey: "", routfl: "", provnc: "", updtby: ""
    }
