...
import { MdlApndixAcpedtDtbase, MdlApndixCurrcvFrntnd } from "../../model/parmas";
...
export default function UixPsglstCurrcvTablex({
  arrdta,
  pagedb,
  acpedt,
  cookie,
}: {
  arrdta: MdlApndixCurrcvFrntnd[];
  pagedb: string;
  ...
  const rawobj: MdlApndixCurrcvFrntnd = FncGlobalIntialObject(arrdta[0]);
  let othrfn: Function | undefined;
  othrfn = (objdta: MdlApndixCurrcvFrntnd) => {
